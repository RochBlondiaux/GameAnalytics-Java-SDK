...
public class ResourceEvent extends Event {
    ...
    @Builder
    public ResourceEvent(String device, String userId, long clientTs, String osVersion, String manufacturer, String platform, UUID sessionId, int sessionNumber, String custom01, String custom02, String custom03, String build, FlowType flowType, Currency currency, String itemType, int amount) {
